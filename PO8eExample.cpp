...
int main(int argc, char **argv)
{
    ...
    /* Connect to the first (0) card.  A second optional argument to
       the connectToCard function allows you to connect to either port
       (0 or 1) on a dual port PO8e card */
